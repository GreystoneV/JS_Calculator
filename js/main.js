...
const Calculator = {
    // This will display 0 on the calculator scree.
    Display_Value: '0',
    // This will hold the first operand for any expressions, we set it to null for now.
    First_Operand: null,
    // This check whether or not the second operand has been inputted by the user.
...
function Input_Decimal(dot) {
    // This endures that accidental clicking of the decimal point doesn't
